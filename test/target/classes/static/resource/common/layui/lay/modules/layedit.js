...
function js_beautify(t, e, i, n) {
    function l() {
        for (; h.length && (" " === h[h.length - 1] || h[h.length - 1] === E);) h.pop()
    }

    function a(t) {
        if (t = void 0 === t || t, l(), h.length) {
            "\n" === h[h.length - 1] && t || h.push("\n");
            for (var e = 0; e < n; e++) h.push(E)
        }
    }
    ...
    function p() {
        ...
        if ("/" === e) {
            var l = "";
            if ("*" === m.charAt(A)) {
                if ((A += 1) < m.length) for (; ("*" !== m.charAt(A) || !m.charAt(A + 1) || "/" !== m.charAt(A + 1)) && A < m.length && (l += m.charAt(A), !((A += 1) >= m.length));) ;
                return A += 2, ["/*" + l + "*/", "TK_BLOCK_COMMENT"]
            }
            if ("/" === m.charAt(A)) {
                for (l = e; "\r" !== m.charAt(A) && "\n" !== m.charAt(A) && (l += m.charAt(A), !((A += 1) >= m.length));) ;
        ...
        if ("'" === e || '"' === e || "/" === e && ("TK_WORD" === g && "return" === v || "TK_START_EXPR" === g || "TK_END_BLOCK" === g || "TK_OPERATOR" === g || "TK_EOF" === g || "TK_END_COMMAND" === g)) {
            var o = e, s = !1;
            if (e = "", A < m.length) for (; (s || m.charAt(A) !== o) && (e += m.charAt(A), s = !s && "\\" === m.charAt(A), !((A += 1) >= m.length));) ;
    ...
    var m, h, y, g, v, x, b, _, E, T, k, w, A, C, N, O, S, K, L, z;
    for (i = i || " ", e = e || 4, E = ""; e--;) E += i;
    for (m = t, x = "", g = "TK_START_EXPR", v = "", h = [], K = !1, L = !1, z = !1, T = "\n\r\t ".split(""), k = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789_$".split(""), w = "+ - * / % & ++ -- = += -= *= /= %= == === != !== > < >= <= >> << >>> >>>= >>= <<= && &= | || ! !! , : ? ^ ^= |=".split(" "), C = "continue,try,throw,return,var,if,switch,case,default,for,while,break,function".split(","), b = "BLOCK", _ = [b], n = n || 0, A = 0, N = !1; ;) {
        var I = p(A);
        if (y = I[0], "TK_EOF" === (S = I[1])) break;
        switch (S) {
            case "TK_START_EXPR":
                L = !1, c("EXPRESSION"), "TK_END_EXPR" === g || "TK_START_EXPR" === g || ("TK_WORD" !== g && "TK_OPERATOR" !== g ? o() : f(x, C) && "function" !== x && o()), s();
                break;
            case "TK_END_EXPR":
                s(), u();
                break;
            ...
            case "TK_OPERATOR":
                var P = !0, R = !0;
                if (L && "," !== y && (z = !0, ":" === y && (L = !1)), ":" === y && N) {
                    s(), a();
                    break
                }
                if (N = !1, "," === y) {
                    L ? z ? (s(), a(), z = !1) : (s(), o()) : "TK_END_BLOCK" === g ? (s(), a()) : "BLOCK" === b ? (s(), a()) : (s(), o());
                    break
                }
...
layui.define(["layer", "form", "code"], function (t) {
    ...
    s.prototype.set = function (t) {
        ...
        var n = this, l = n.config, o = "layui-layedit", s = i("string" == typeof t ? "#" + t : t),
            c = "LAY_layedit_" + ++n.index, u = s.next("." + o), f = i.extend({}, l, e), p = function () {
                var t = [], e = {};
        ...
        return a.ie && a.ie < 8 ? s.removeClass("layui-hide").addClass("layui-show") : (u[0] && u.remove(), r.call(n, m, s[0], f), s.addClass("layui-hide").after(m), layui.use(["colorpicker", "jquery"], function () {
    ...
    var r = function (t, e, n) {
        ...
        a.css({height: n.height}).on("load", function () {
            var o = a.contents(), s = a.prop("contentWindow"), r = o.find("head"),
            ...
            r.append(d), r.append(f), c.attr("contenteditable", "true").css({"min-height": n.height}).html(e.value || ""), u.apply(l, [s, a, e, n]), g.call(l, s, t, n)
        })
    }, d = function (t) {
        ...
        var s = t.document, r = i(s.body);
        r.on("keydown", function (t) {
            var e = t.keyCode;
            if (13 === e) {
                var d = p(s), c = m(d), u = c.parentNode;
            ...
            if (8 === e) {
                var d = p(s), c = m(d);
                if ("<hr>" == c.innerHTML && "BODY" == c.tagName && (d.selectNode(c.childNodes[0]), d.deleteContents()), c.hasChildNodes() && "BODY" != c.tagName) {
                    var f = o.calldel;
                    "" != f.url && ("IMG" != d.commonAncestorContainer.childNodes[d.startOffset - 1].tagName || i.post(f.url, {imgpath: d.commonAncestorContainer.childNodes[d.startOffset - 1].src}, function (t) {
                        f.done(t)
                    }))
                }
            }
            if (46 === e) {
                ...
                if ("IMG" === c.nextElementSibling.tagName) {
                    var f = o.calldel;
                    "" != f.url && i.post(f.url, {imgpath: c.nextElementSibling.src}, function (t) {
                        f.done(t)
                    })
                }
            }
            ...
            if (e.originalEvent.clipboardData && e.originalEvent.clipboardData.items) {
                for (var c = 0, u = e.originalEvent.clipboardData.items.length; c < u; c++) {
                    var h = e.originalEvent.clipboardData.items[c];
                    if ("file" === h.kind) {
                        var y = h.getAsFile(), g = new FormData;
                        g.append("file", y);
                        var v = o.uploadImage.url, x = "";
                        if (i.ajax({
                            type: "POST",
                            url: v,
                            data: g,
                            ...
                            if (b.src = x, a.ie) n.msg("暂不支持IE浏览器"); else {
                                var _ = m(d);
                                "<br>" == _.innerHTML && (d.selectNode(_), d.deleteContents()), d.deleteContents(), d.insertNode(b)
                            }
                        } else n.msg("unkwon error")
                    }
                }
                setTimeout(function () {
        ...
        var e = this;
        e.document;
        t.find(".MsoNormal,.MsoListParagraph").each(function () {
            this.removeAttribute("class")
        }), t.html(t.html().replace(/<o:p> <\/o:p>/g, "")), t.html(t.html().replace(/o:/g, "")), t.html(t.html().replace(/<font>/gi, "")), t.html(t.html().replace(/<span>/gi, "")), t.html(t.html().replace(/<span [^>]+>/gi, "")), t.html(t.html().replace(/<\/span>/gi, "")), t.html(t.html().replace(/<P>/g, "")), t.html(t.html().replace(/<\/P>/g, "")), t.html(t.html().replace(/<p><\/p>/g, ""))
    }, p = function (t) {
        return t.selection ? t.selection.createRange() : t.getSelection().getRangeAt(0)
    }, m = function (t) {
        return t.endContainer || t.parentElement().childNodes[0]
    }, h = function (t, e, i) {
        var l = this.document, o = document.createElement(t);
        ...
        if (o.removeAttribute("text"), a.ie) {
            ...
            var d = m(i);
            d.parentNode;
            "<br>" == d.innerHTML && (i.selectNode(d), i.deleteContents()), i.deleteContents(), i.insertNode(o), "img" == t && "<br>" == d.innerHTML && (l.execCommand("formatBlock", !1, "<p>"), l.execCommand("justifyCenter"), setTimeout(function () {
                body.focus()
            }, 10))
        }
    }, y = function (t, e) {
        var n = this.document, l = "layedit-tool-active", a = m(p(n)), s = function (e) {
        ...
        var a = t.document, s = i(a.body), r = {
            link: function (e) {
                var n = m(e), a = i(n).parent();
                v.call(s, {
                    href: a.attr("href"),
                    ...
                    var n = a[0];
                    if ("A" === n.tagName) n.href = i.url, n.rel = i.rel, "" == i.rel && n.removeAttr("rel"), n.target = i.target, "_self" != i.target && void 0 != i.target || n.removeAttr("target"), "" != i.text && (n.text = i.text); else {
                        var l = {target: i.target, href: i.url, rel: i.rel, text: i.text};
                        "" != i.rel && void 0 != i.rel || delete l.rel, "_self" != i.target && void 0 != i.target || delete l.target, "" == i.text && (l.text = l.href), h.call(t, "a", l, e)
                    }
                })
            }, unlink: function (t) {
                a.execCommand("unlink")
            }, face: function (e) {
                E.call(this, {facePath: l.facePath}, function (i) {
                ...
                var i = l.codeConfig || {hide: !1, encode: !0, class: "layui-code"};
                A.call(s, {hide: i.hide, default: i.default}, function (n) {
                ...
                n.open({
                    ...
                    yes: function (i, l) {
                        var a = "";
                        if ("" != l.find('input[name="imgWidth"]').val()) {
                            var o = l.find('input[name="imgWidth"]').val();
                            a += o.indexOf("%") > 0 ? "width:" + o : "width:" + o + "px;"
                        }
                        if ("" != l.find('input[name="imgHeight"]').val()) {
                            var s = l.find('input[name="imgHeight"]').val();
                            a += s.indexOf("%") > 0 ? "height:" + s : "height:" + s + "px;"
                        }
                        0 === l.find("#imgsPrev").find("img").length ? n.msg("请选择要插入的图片") : ("" != a && (a = "style='" + a + "'"), h.call(t, "p", {text: l.find("#imgsPrev").html().replace(new RegExp(/(style="max-width:70px;margin:2px")/g), a)}, e), n.close(i))
                    },
                    btn2: function (t, e) {
                        if (e.find("#imgsPrev img").length > 0) {
                            for (var n = "", a = 0; a < e.find("#imgsPrev img").length; a++) n += e.find("#imgsPrev img")[a].src;
                            var o = l.calldel;
                            "" != o.url && i.post(o.url, {imgpath: n}, function (t) {
                                o.done(t)
                            })
                        }
                    },
                    ...
                    success: function (t, e) {
                        layui.use("upload", function () {
                            var e = layui.upload, a = l.uploadImage || {};
                            ...
                            e.render({
                                ...
                                before: function (t) {
                                    o = n.msg("文件上传中,请稍等", {
                                        ...
                                        -1 === s.indexOf(t) && i("#imgsPrev").append('<img data-index="' + t + '" src="' + n + '" alt="' + e.name + '" style="max-width:70px;margin:2px" /> ')
                                    })
                                },
                                allDone: function () {
                                    for (var t = 0; t < s.length; t++) i("#imgsPrev").find('img[data-index="' + s[t] + '"]').remove();
                                    n.close(o)
                                },
                                error: function (t, e) {
                                    s.push(t)
                                    ...
                                    0 == e.code ? (e.data = e.data || {}, i('#imgsPrev img[data-index="' + o + '"]').attr("src", e.data.src), a.done(e)) : 2 == e.code ? (e.data = e.data || {}, i('#imgsPrev img[data-index="' + o + '"]').attr("src", e.data.src), a.done(e)) : n.msg(e.msg || "上传失败"), t.find("#imgsPrev img").on("click", function () {
                                        var t = this.src, e = this.getAttribute("data-index");
                                        n.confirm("是否删除该图片?", {icon: 3, title: "提示"}, function (a) {
                                            var o = l.calldel;
                                            "" != o.url ? i.post(o.url, {imgpath: t}, function (t) {
                ...
                n.open({
                    ...
                    yes: function (i, l) {
                        ...
                        if ("" != l.find('input[name="imgWidth"]').val()) {
                            var r = l.find('input[name="imgWidth"]').val();
                            a += r.indexOf("%") > 0 ? "width:" + r : "width:" + r + "px;"
                        }
                        if ("" != l.find('input[name="imgHeight"]').val()) {
                            var d = l.find('input[name="imgHeight"]').val();
                            a += d.indexOf("%") > 0 ? "height:" + d : "height:" + d + "px;"
                        }
                        if ("" == s.val()) n.msg("请选择一张图片或输入图片地址"); else {
                            var c = {src: s.val()};
                            "" != o.val() && (c.alt = o.val()), "" != a && (c.style = a), h.call(t, "img", c, e), n.close(i)
                        }
                    },
                    btn2: function (t, e) {
                        var n = l.calldel;
                        "" != n.url && i.post(n.url, {imgpath: e.find('input[name="Imgsrc"]').val()}, function (t) {
                            n.done(t)
                        })
                    },
                    cancel: function (t, e) {
                    ...
                    success: function (t, e) {
                        layui.use("upload", function (e) {
                            ...
                            "" == s.url && n.msg("上传接口配置错误！"), e.render({
                                elem: "#LayEdit_InsertImage",
                                url: s.url,
                                method: s.method,
                                data: s.data,
                                headers: s.headers,
                                accept: s.accept || "image",
                                acceptMime: s.acceptMime || "image/*",
                                exts: s.exts || "jpg|png|gif|bmp|jpeg",
                                size: s.size || 10240,
                                field: s.field,
                                before: function (t) {
                                    ...
                                    if (n.close(i), 0 == t.code) t.data = t.data || {}, o.val(t.data.src), a.val(t.data.name), s.done(t); else if (2 == t.code) var r = n.open({
                                        type: 1,
                                        anim: 2,
                                        icon: 5,
                                        title: "提示",
                                        ...
                                        btn: ["确定", "取消"],
                                        yes: function () {
                                            t.data = t.data || {}, o.val(t.data.src), a.val(t.data.name), n.close(r)
                                        }
                ...
                a.video.title.length > 0 && (o = AddCustomThemes(a.video.title, a.video.content, a.video.preview)), n.open({
                    ...
                    btnAlign: "c",
                    yes: function (i, o) {
                        var s = o.find('input[name="video"]'), r = o.find('input[name="cover"]'),
                            d = o.find('select[name="theme"]');
                        if ("" == s.val()) n.msg("请选择一个视频或输入视频地址"); else {
                            var c = '&nbsp;<video src="' + s.val() + '" poster="' + r.val() + '" ' + l.videoAttr + ' controls="controls" >您的浏览器不支持video播放</video>&nbsp;',
                                u = "";
                            a.video.title.length > 0 && d.length > 0 && (u = d[0].options[d[0].selectedIndex].value), h.call(t, "div", {
                                text: c,
                                class: u
                            }, e), n.close(i)
                        }
                    ...
                    success: function (t, e) {
                        layui.use("upload", function (e) {
                            var i, o = t.find('input[name="video"]'), s = t.find('input[name="cover"]'),
                                e = layui.upload, r = l.uploadImage || {};
                            ...
                            "" == d.url && n.msg("视频上传接口配置错误！"), e.render({
                                ...
                                before: function (t) {
                                    ...
                                    if (n.close(i), 0 == t.code) t.data = t.data || {}, s.val(t.data.src), r.done(t); else if (2 == t.code) var a = n.open({
                                        type: 1,
                                        anim: 2,
                                        icon: 5,
                                        title: "提示",
                ...
                n.open({
                    ...
                    btnAlign: "c",
                    yes: function (i, l) {
                        0 === l.find("#filesPrev").find("a").length ? n.msg("请选择要上传的附件") : (h.call(t, "p", {text: l.find("#filesPrev").html()}, e), n.close(i))
                    },
                    success: function (a, o) {
                        layui.use("upload", function () {
                            var s = layui.upload, r = l.uploadFiles || {};
                            ...
                            s.render({
                                ...
                                before: function (t) {
                                    t.preview(function (t, e, n) {
                                        -1 === d.indexOf(t) && i("#filesPrev").append('<a data-index="' + t + '" target="_blank" href="' + n + '" alt="' + e.name + '" >' + e.name + "</a>&nbsp;")
                                    })
                                },
                                allDone: function () {
                                    for (var l = 0; l < d.length; l++) i("#filesPrev").find('a[data-index="' + d[l] + '"]').remove();
                                    r.autoInsert && (h.call(t, "p", {text: a.find("#filesPrev").html()}, e), n.close(o))
                                },
                                error: function (t, e) {
                                    d.push(t)
                                },
                                done: function (t, e, o) {
                                    0 == t.code ? (t.data = t.data || {}, i('#filesPrev a[data-index="' + e + '"]').attr("href", t.data.src), r.done(t)) : 2 == t.code ? (n.msg(t.msg || "上传失败"), t.data = t.data || {}, i('#filesPrev a[data-index="' + e + '"]').attr("href", t.data.src), r.done(t)) : n.msg(t.msg || "上传失败"), a.find("#filesPrev a").on("click", function () {
                                        var t = this.getAttribute("data-index");
                                        n.confirm("是否删除该附件?", {icon: 3, title: "提示"}, function (e) {
                                            var a = l.calldel;
                                            "" != a.url ? i.post(a.url, {filepath: this.href}, function (e) {
                                                i("#filesPrev").find('a[data-index="' + t + '"]').remove(), a.done(e)
                                            }) : (n.msg("没有配置回调参数"), i("#filesPrev").find('a[data-index="' + t + '"]').remove()), n.close(e)
                                        })
                                    })
                                }
                            })
                ...
                if (-1 == n.parentElement.nextElementSibling.lastElementChild.id.indexOf("aceHtmleditor")) {
                    ...
                    l.indexOf("</pre>") > -1 && (l = l.replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&#39;/g, "'").replace(/&quot;/g, '"')), l = style_html(l, 4, " ", 80), n.parentElement.nextElementSibling.setAttribute("style", "z-index: 999; overflow: hidden;height:" + n.parentElement.nextElementSibling.clientHeight + "px"), null !== this.parentElement.parentElement.getAttribute("style") && this.parentElement.nextElementSibling.setAttribute("style", "z-index: 999; overflow: hidden;height: " + (this.parentElement.parentElement.offsetHeight - this.parentElement.offsetHeight - 14) + "px"), n.parentElement.nextElementSibling.firstElementChild.style = "position: absolute;left: -32768px;top: -32768px;";
                    ...
                    n.parentElement.nextElementSibling.removeAttribute("style"), this.parentElement.nextElementSibling.firstElementChild.style = "height:" + r + "px", this.parentElement.nextElementSibling.lastElementChild.remove(), i(n).siblings("i").removeClass("layui-disabled")
                }
                ...
                var a = l.previewAttr || {area: ["50%", "100%"], offset: "r"},
                    o = this.parentElement.nextElementSibling.firstElementChild.contentDocument.body.innerHTML;
                n.open({
                    type: 1, id: "layui-kz-preview", title: "预览", shade: .05, maxmin: !0, full: function (t) {
                        t[0].style.height = i(".layui-layer-shade").offsetHeight + "px", t[0].children[1].style.height = i(".layui-layer-shade").offsetHeight - 43 + "px"
                    }, min: function (t) {
                    }, restore: function (t) {
                        t[0].style.height = document.body.clientHeight - 100 + "px", t[0].children[1].style.height = document.body.clientHeight - 143 + "px"
                    }, shadeClose: !0, area: function () {
                        return /mobile/i.test(navigator.userAgent) || i(window).width() <= 485 ? ["90%", "90%"] : a.area
                    }(), offset: function () {
                        return /mobile/i.test(navigator.userAgent) ? "auto" : a.offset
                    }(), content: e.join("") + o, success: function (t, e) {
                        n.setTop(t)
                    }
                })
                ...
                }, i = {}, n = {}, o = e.code, r = e.text, d = function () {
                ...
                T.call(this, {fonts: d, texts: c}, function (t) {
                ...
                }, n = {}, a = {}, o = i.code, r = i.text, d = function () {
                    return layui.each(o, function (t, e) {
                        n[t] = e
                    }), n
                }(), c = function () {
                ...
                k.call(this, {fonts: d, texts: c}, function (i) {
                    h.call(t, "span", {style: i, text: "&nbsp;"}, e), setTimeout(function () {
                        s.focus()
                    }, 10)
                })
            }, fontSize: function (e) {
                ...
                w.call(this, {fonts: d, texts: c}, function (i) {
                    h.call(t, "span", {style: i, text: "&nbsp;"}, e), setTimeout(function () {
                        s.focus()
                    }, 10)
                })
                ...
                var n = m(e), a = i(n).parent();
                x.call(s, {title: l.customlink.title}, function (i) {
                    var n = a[0];
        ...
        }, d = e.find(".layui-layedit-tool"), c = function () {
            var e = i(this), n = e.attr("layedit-event"), l = e.attr("lay-command");
            if (!e.hasClass(o)) {
                s.focus();
                var c = p(a), u = c.commonAncestorContainer;
                l ? (/justifyLeft|justifyCenter|justifyRight/.test(l) && "BODY" === u.parentNode.tagName && a.execCommand("formatBlock", !1, "<p>"), a.execCommand(l), setTimeout(function () {
                    ...
                    s.focus()
                }, 10)) : r[n] && r[n].call(this, c, a), y.call(t, d, e)
            }
        }, u = /image/;
        d.find(">i").on("mousedown", function () {
            ...
            y.call(t, d), n.close(E.index), n.close(_.index), n.close(T.index), n.close(k.index), n.close(w.index)
        });
        var f = null, g = function (t) {
            var e = l.rightBtn || {
                type: "layBtn", customEvent: function (t, e) {
                }
            };
                    ...
                    case "IMG":
                        f = n.open({
                            ...
                            yes: function (e, i) {
                                ...
                                "" == l ? n.msg("请选择一张图片或输入图片地址") : (t.target.src = l, t.target.alt = i.find('input[name="altStr"]').val(), t.target.style.width = "" != a ? a.indexOf("%") > 0 ? a : a + "px" : "", t.target.style.height = "" != o ? o.indexOf("%") > 0 ? o : o + "px" : "", n.close(e))
                            },
                            btn2: function (t, e) {
                            },
                            btn3: function (e, a) {
                                var o = l.calldel;
                                "" != o.url ? i.post(o.url, {imgpath: t.target.src}, function (e) {
                                    t.toElement.remove(), o.done(e)
                                }) : t.toElement.remove(), n.close(e)
                            },
                            success: function (t, e) {
                                var i = l.uploadImage || {};
                                return "" == i.url && n.msg("图片上传接口配置错误！"), layui.use("upload", function (e) {
                                    ...
                                    e = layui.upload, e.render({
                                        ...
                                        data: i.data,
                                        headers: i.headers,
                                        accept: i.accept || "image",
                                        acceptMime: i.acceptMime || "image/*",
                                        exts: i.exts || "jpg|png|gif|bmp|jpeg",
                                        size: i.size || 10240,
                                        field: i.field,
                                        before: function (t) {
                            ...
                            success: function (t, e) {
                                layui.use("upload", function (e) {
                                    var i, a = t.find('input[name="video"]'), o = t.find('input[name="cover"]'),
                                        e = layui.upload, r = l.uploadImage || {}, d = l.uploadVideo || {};
                                    "" == r.url && n.msg("图片上传接口配置错误！"), "" == d.url && n.msg("视频上传接口配置错误！"), e.render({
                                        ...
                                        before: function (t) {
                                            ...
                                            if (n.close(i), 0 == t.code) t.data = t.data || {}, a.val(t.data.src), d.done(t); else if (2 == t.code) var o = n.open({
                                                type: 1,
                                                anim: 2,
                                                icon: 5,
                                                title: "提示",
                    ...
                    default:
                        f = n.open({
                            ...
                            offset: function () {
                                ...
                                var e = l._elem.next().find("iframe").get(0);
                                return [e.offsetTop + t.clientY + o.getBoundingClientRect().y + "px", e.offsetLeft + t.clientX + o.getBoundingClientRect().x + "px"]
                            }(),
                            shade: function () {
                            ...
                            success: function (e, s) {
                                ...
                                }), e.find(".context-menu-delete").on("click", function () {
                                    "BODY" == a.tagName ? n.msg("不能再删除了") : "VIDEO" == a.tagName ? "" != r.url ? i.post(r.url, {
                                        filepath: t.target.src,
                                        imgpath: t.target.poster
                                    }, function (t) {
                                        o.remove(), r.done(t)
                                    }) : o.remove() : "IMG" == a.tagName && "" != r.url ? i.post(r.url, {para: t.target.src}, function (t) {
                                        a.remove(), r.done(t)
                                    }) : a.remove(), n.close(s)
                                })
                            }
        ...
        return t.hide = t.hide || function (e) {
            ...
            success: function (t, e) {
                t.find(".layui-clear>li").on("click", function () {
                    l && l({src: a[this.title], alt: this.title}), n.close(e)
                })
            }
            ...
            tips: 1, time: 0, skin: "layui-box layui-util-face", maxWidth: 500, success: function (e, o) {
                e.css({marginTop: -4, marginLeft: -10}).find(".layui-clear>li").on("click", function () {
                    l && l({src: a[this.title], alt: this.title}), n.close(o)
                }), i(document).off("click", t.hide).on("click", t.hide)
            }
        })
    }, T = function t(e, l) {
        ...
        t.hide = t.hide || function (e) {
            "fontfamily" != i(e.target).attr("layedit-event") && n.close(t.index)
        }, t.index = n.tips(function () {
            var t = [];
            return layui.each(e.fonts, function (i, n) {
        ...
        t.hide = t.hide || function (e) {
            "fontSize" != i(e.target).attr("layedit-event") && n.close(t.index)
        }, t.index = n.tips(function () {
            var t = [];
            return layui.each(e.fonts, function (i, n) {
                t.push('<li title="' + e.fonts[i] + '" style="float: initial;width:100%;' + e.fonts[i] + '"><' + e.fonts[i] + ">" + e.texts[i] + "</" + e.fonts[i] + "></li>")
