...
public class PermissionController {
    ...
    public ModelAndView addPermissionForRole(ModelAndView mv, String roleId) {
        ...
        for (SubSystemInfo sys : sysList) {
            ...
            sysMap.put("checked", permissionService.thisRoleHavePer(roleId, sys.getSubSystemId()) ? "true" : "false");
            ...
            for (Map<String, Object> objectMap : mapList) {
                ...
                if (permissionService.thisRoleHavePer(roleId, id)) {
